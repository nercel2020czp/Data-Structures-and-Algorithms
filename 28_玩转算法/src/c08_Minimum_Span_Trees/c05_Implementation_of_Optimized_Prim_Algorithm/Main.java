package c08_Minimum_Span_Trees.c05_Implementation_of_Optimized_Prim_Algorithm;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String filename1 = "src/c08_Minimum_Span_Trees/c05_Implementation_of_Optimized_Prim_Algorithm/testG1.txt";
        int V1 = 8;

        String filename2 = "src/c08_Minimum_Span_Trees/c05_Implementation_of_Optimized_Prim_Algorithm/testG2.txt";
        int V2 = 250;

        String filename3 = "src/c08_Minimum_Span_Trees/c05_Implementation_of_Optimized_Prim_Algorithm/testG3.txt";
        int V3 = 1000;

        String filename4 = "src/c08_Minimum_Span_Trees/c05_Implementation_of_Optimized_Prim_Algorithm/testG4.txt";
        int V4 = 10000;
